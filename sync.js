...
// Credentials below are the same Supabase project URL +
// publishable key used in topbar.js/gym.html.
// =============================================================
(function () {
  'use strict';
  const SUPABASE_URL = 'https://nozpgunkuckdjgurfdtv.supabase.co';
  const SUPABASE_KEY = 'sb_publishable_iSC197G7zQrKdqCBWW5Gmg_4InWEG5r';
